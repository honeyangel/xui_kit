...
xui_method_explain(onity_tileview, set_viewtext,				void						)( const std::wstring& viewtext )
{
...
xui_method_explain(onity_tileview, get_shownodes,				std::vector<xui_treenode*>	)( void )
{
