...
xui_implement_rtti(cocos_console, xui_dockpage);

/*
//constructor
*/
xui_create_explain(cocos_console)( void )
: xui_dockpage(xui_vector<s32>(300), AREALIMIT_T|AREALIMIT_B, 200, DOCKSTYLE_B)
{
	ini_namectrl(cocos_resource::icon_console, L"Console");

	m_clear		= new xui_button(xui_vector<s32>(60, 20));
	xui_method_ptrcall(m_clear,		xm_buttonclick	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_clearclick);
	...
	xui_method_ptrcall(m_error,		xm_toggleclick	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggleclick);
	xui_method_ptrcall(m_error,		xm_textchanged	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggletextchanged);
	...
	xui_method_ptrcall(m_error,		ini_drawer		)(cocos_resource::icon_error);
	...
	xui_method_ptrcall(m_warning,	xm_toggleclick	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggleclick);
	xui_method_ptrcall(m_warning,	xm_textchanged	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggletextchanged);
	...
	xui_method_ptrcall(m_warning,	ini_drawer		)(cocos_resource::icon_warning);
	...
	xui_method_ptrcall(m_message,	xm_toggleclick	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggleclick);
	xui_method_ptrcall(m_message,	xm_textchanged	) += new xui_method_member<xui_method_args, cocos_console>(this, &cocos_console::on_toggletextchanged);
	...
	xui_method_ptrcall(m_message,	ini_drawer		)(cocos_resource::icon_message);
...
//destructor
*/
xui_delete_explain(cocos_console)( void )
{
...
xui_method_explain(cocos_console, game_print,			void)( const std::string& log )
{
	...
	cocos_console* console = cocos_mainform::get_ptr()->get_console();
...
//method
*/
xui_method_explain(cocos_console, add_log,				void)( u08 type, const std::wstring& file, const std::wstring& text )
{
	...
	case LOGTYPE_ERROR:		
		togg = m_error;	
		icon = cocos_resource::icon_bigerror;
		temp << L"error:";
		break;
	case LOGTYPE_WARNING:	
		togg = m_warning; 
		icon = cocos_resource::icon_bigwarning;
		temp << L"warning:";
		break;
	case LOGTYPE_MESSAGE:	
		togg = m_message; 
		icon = cocos_resource::icon_bigmessage;
		temp << L"log:";
		break;
	}
...
xui_method_explain(cocos_console, del_logall,			void)( void )
{
	m_list->del_itemall();
	for (u08 itype = 0; itype < LOGTYPE_MAX; ++itype)
	{
...
//event
*/
xui_method_explain(cocos_console, on_toggletextchanged, void)( xui_component* sender, xui_method_args& args )
{
...
xui_method_explain(cocos_console, on_toggleclick,		void)( xui_component* sender, xui_method_args& args )
{
	xui_toggle* togg = NULL;
	u08         type = 0;
...
xui_method_explain(cocos_console, on_clearclick,		void)( xui_component* sender, xui_method_args& args )
{
	del_logall();
}
...
//method
*/
xui_method_explain(cocos_console, add_item,				void)( u08 type, xui_listitem* item )
{
...
xui_method_explain(cocos_console, add_item,				void)( u08 type )
{
...
xui_method_explain(cocos_console, del_item,				void)( u08 type )
{
