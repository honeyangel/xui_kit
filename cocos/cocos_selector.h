#ifndef __cocos_selector_h__
#define __cocos_selector_h__

#include "xui_propctrl_object.h"

class cocos_fileview;
class cocos_preview;
class cocos_selector : public xui_object_pickwnd
{
	xui_declare_rtti
...
protected:
	...
	*/
	...
	s32							convert_droptype		( const std::string& droptype );
