...
//constructor
*/
xui_create_explain(cocos_boundbox)( xui_proproot* prop, u08 type )
: m_linkprop(prop)
, m_sizetype(type)
...
//position
*/
xui_method_explain(cocos_boundbox, get_position,	xui_vector<s32>	)( const xui_vector<s32>& trans, f64 ratio )
{
...
//bounding
*/
xui_method_explain(cocos_boundbox, get_bounding,	xui_rect2d<s32>	)( const xui_vector<s32>& trans, f64 ratio )
{
...
xui_method_explain(cocos_boundbox, opt_bounding,	void			)( const xui_vector<s32>& trans, f64 ratio, const xui_vector<s32>& delta, u08 op )
{
	if (op != BO_NONE)
	{
		switch (op)
...
//method
*/
xui_method_explain(cocos_boundbox, get_linkprop,	xui_proproot*	)( void )
{
	return m_linkprop;
}
xui_method_explain(cocos_boundbox, syn_bounding,	void 			)( const xui_vector<s32>& trans, f64 ratio )
{
	m_bounding = get_bounding(trans, ratio);
}
xui_method_explain(cocos_boundbox, hit_operator,	u08				)( const xui_vector<s32>& trans, f64 ratio, const xui_vector<s32>& pt )
{
...
//draw
*/
xui_method_explain(cocos_boundbox, draw,			void			)( const xui_vector<s32>& trans, f64 ratio, const xui_vector<s32>& pt, bool alwaysdraw )
{
...
xui_method_explain(cocos_boundbox, draw_bounding,	void			)( const xui_rect2d<s32>& rt, const xui_vector<s32>& pivot )
{
