...
//static
*/
xui_method_explain(onity_propeditnode, get_pos,			xui_vector<f64>	)( void* userptr )
{
	onity_propeditnode* prop = (onity_propeditnode*)userptr;
	return prop->ori_position().to<f64>();
}
xui_method_explain(onity_propeditnode, set_pos,			void			)( void* userptr, const xui_vector<f64>& value )
{
	onity_propeditnode* prop = (onity_propeditnode*)userptr;
