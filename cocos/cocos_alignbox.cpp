...
//constructor
*/
xui_create_explain(cocos_alignbox)( const xui_vector<s32>& button_size, get_func func )
: m_func(func)
{
	m_left		= new xui_button(button_size);
	xui_method_ptrcall(m_left,		ini_drawer		)(cocos_resource::icon_horzleft);
	...
	xui_method_ptrcall(m_left,		xm_buttonclick	) += new xui_method_member<xui_method_args,	cocos_alignbox>(this, &cocos_alignbox::on_horzbuttonclick);
	m_right		= new xui_button(button_size);
	xui_method_ptrcall(m_right,		ini_drawer		)(cocos_resource::icon_horzright);
	...
	xui_method_ptrcall(m_right,		xm_buttonclick	) += new xui_method_member<xui_method_args,	cocos_alignbox>(this, &cocos_alignbox::on_horzbuttonclick);
	m_hcenter	= new xui_button(button_size);
	xui_method_ptrcall(m_hcenter,	ini_drawer		)(cocos_resource::icon_horzcenter);
	...
	xui_method_ptrcall(m_hcenter,	xm_buttonclick	) += new xui_method_member<xui_method_args, cocos_alignbox>(this, &cocos_alignbox::on_horzbuttonclick);

	m_top		= new xui_button(button_size);
	xui_method_ptrcall(m_top,		ini_drawer		)(cocos_resource::icon_verttop);
	...
	xui_method_ptrcall(m_top,		xm_buttonclick	) += new xui_method_member<xui_method_args,	cocos_alignbox>(this, &cocos_alignbox::on_vertbuttonclick);
	m_bottom	= new xui_button(button_size);
	xui_method_ptrcall(m_bottom,	ini_drawer		)(cocos_resource::icon_vertbottom);
	...
	xui_method_ptrcall(m_bottom,	xm_buttonclick	) += new xui_method_member<xui_method_args,	cocos_alignbox>(this, &cocos_alignbox::on_vertbuttonclick);
	m_vcenter	= new xui_button(button_size);
	xui_method_ptrcall(m_vcenter,	ini_drawer		)(cocos_resource::icon_vertcenter);
	...
	xui_method_ptrcall(m_vcenter,	xm_buttonclick	) += new xui_method_member<xui_method_args, cocos_alignbox>(this, &cocos_alignbox::on_vertbuttonclick);
...
//method
*/
xui_method_explain(cocos_alignbox, get_horzline,		xui_linebox*)( void )
{
	return m_horzline;
}
xui_method_explain(cocos_alignbox, get_vertline,		xui_linebox*)( void )
{
	return m_vertline;
}
xui_method_explain(cocos_alignbox, set_lineupdate,		void		)( void )
{
...
//event
*/
xui_method_explain(cocos_alignbox, on_horzbuttonclick,	void		)( xui_component* sender, xui_method_args& args )
{
	std::vector<cocos_boundbox*> vec = (*m_func)();
	if (vec.size() > 1)
	{
...
xui_method_explain(cocos_alignbox, on_vertbuttonclick,	void		)( xui_component* sender, xui_method_args& args )
{
	std::vector<cocos_boundbox*> vec = (*m_func)();
	if (vec.size() > 1)
	{
