...
public:
	...
	void								set_timelinevisible			( xui_timeline* line );
	...
	xui_method<xui_method_args>			xm_addframe;
	xui_method<xui_method_args>			xm_delframe;
...
protected:
	...
	void								on_timelinekeybddown		( xui_component* sender, xui_method_keybd&			args );
