...
: xui_window(xui_vector<s32>(480, 640), true)
{
	...
	xui_method_ptrcall(m_selectall, xm_toggleclick		) += new xui_method_member<xui_method_args, onity_save>(this, &onity_save::on_toggleclick);
	...
	xui_method_ptrcall(m_yes,		xm_buttonclick		) += new xui_method_member<xui_method_args, onity_save>(this, &onity_save::on_buttonclick);
	...
	xui_method_ptrcall(m_no,		xm_buttonclick		) += new xui_method_member<xui_method_args, onity_save>(this, &onity_save::on_buttonclick);
...
//callback
*/
xui_method_explain(onity_save, on_updateself,		void)( xui_method_update& args )
{
...
xui_method_explain(onity_save, on_toggleclick,		void)( xui_component* sender, xui_method_args& args )
{
	for (u32 i = 0; i < m_save->get_upmostnodecount(); ++i)
	{
...
xui_method_explain(onity_save, quit,				void)( void )
{
	::PostQuitMessage(0);
}
