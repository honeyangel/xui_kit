...
//constructor
*/
xui_create_explain(cocos_propdata_spineatlas)(
	xui_propkind*		kind,
	const std::wstring& name,
	get_func			userget,
	set_func			userset,
	void*				userptr )
: xui_propdata_object_func(kind, name, xui_propctrl_object::create, "SpineAtlas", cocos_selector::get_ptr, get_icon, get_name, userget, userset, userptr)
{
	xm_doubleclick += new xui_method_member<xui_method_args, cocos_propdata_spineatlas>(this, &cocos_propdata_spineatlas::on_doubleclick);
}

/*
//event
*/
xui_method_explain(cocos_propdata_spineatlas, on_doubleclick,	void		)( xui_component* sender, xui_method_args& args )
{
...
//static
*/
xui_method_explain(cocos_propdata_spineatlas, get_icon,			xui_bitmap*	)( xui_propdata* propdata )
{
	return cocos_resource::icon_module;
}
xui_method_explain(cocos_propdata_spineatlas, get_name,			std::wstring)( xui_propdata* propdata )
{
